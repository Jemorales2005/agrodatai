...
export class DashboardComponent implements OnInit {
  ...
  menuLateral: any = [
    { id:1, icono:'fa fa-home', titulo:'Tableros', link:'default', submenu:1, items_sub: [{icono_sub:'far fa-arrow-alt-circle-right', titulo_sub:'Opción 1'},{icono_sub:'far fa-arrow-alt-circle-right', titulo_sub:'Opción 2'}]},
    { id:2, icono:'fa fa-arrow-circle-right', titulo:'Mejor opción de venta', link:'mejor-opcion-venta', submenu:0, items_sub:[]},
    { id:3, icono:'fa fa-leaf', titulo:'Producción', link:'produccion', submenu:1, items_sub:[{icono_sub:'far fa-arrow-alt-circle-right', titulo_sub:'Opcion 1'}]},
    ...
    { id:9, icono:'fas fa-bug', titulo:'Sanitario', link:'saniatrio', submenu:0, items_sub:[]},
